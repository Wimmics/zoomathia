...
const BookPage = () => {
    ...
    const getBookList = useCallback((e) => {
        ...
        const callForData = async () => {
            const data = await fetch(`http://localhost:3001/getBookList?title=${e.target.value}`).then(response => response.json())
    ...
    const getWorks = useCallback((e) => {
        ...
        const callForData = async () => {
            const data = await fetch(`http://localhost:3001/getWorks?author=${e.target.value}`).then(response => response.json())
