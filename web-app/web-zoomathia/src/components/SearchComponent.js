...
const SearchComponent = () => {
        ...
        if(Object.keys(data_retreive.tree).length === 0){
            ...
            setStats(<section className={styles["selected-book-metadata"]}>
                <div className={styles["block-stat"]}>
                    ...
                    <p>Request time: {((time2 - time1) / 1000).toFixed(2)} s</p>
                </div>
                <div className={styles["block-stat"]}>
            ...
            setSummary(<div key="main" className={styles["ul-toc"]}>
                ...
                <ul>{data_retreive.tree !== null ? data_retreive.tree.map(node => 
    ...
    return <div className={styles["box-content"]}>
        ...
        <Grid container spacing={2}>
            <Grid size={12}>{stats}</Grid>
            <Grid size={2}>{summary}</Grid>
            <Grid size={10}>{searchResult}</Grid>
        </Grid>
    </div>
}
