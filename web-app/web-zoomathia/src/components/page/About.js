...
const About = () => {
    return <section className={styles["box-content"]}>
        <section className={styles["home-project"]}>
            ...
            <p><br />It relies on the exploitation of a knowledge graph annotating the
            ...
            <p><br />The pipeline for the automatic construction of this knowledge graph was
            developed within the framework of the <a href="https://univ-cotedazur.fr/recherche-innovation/structures-de-recherche/academies-dexcellence/academies-dexcellence-homme-idees-et-milieux/projets-de-recherche/projets-2020-2024/automazoo-annotation-automatique-dun-corpus-zoologique-ancien" rel="noreferrer" target="_blank">AutomaZoo project</a> funded by the
